    ...
    <div class="container">
        ...
        <form action="" class="main-form" onsubmit="return myfun()" method='POST'>
            ...
            <div class="form">
                ...
                <input type="password" placeholder="Enter your password" name="password" id="password1" autocomplete="off">
                <i class="fas sucess">&#xf058;</i>
                <i class="fas error">&#xf06a;</i>
                <small class="message">error message</small>
            </div>
            <div class="form">
                ...
                <input type="password" placeholder="Please re-enter your password" name="cf_password" id="password2" autocomplete="off">
                <i class="fas sucess">&#xf058;</i>
                <i class="fas error">&#xf06a;</i>
                <small class="message">error message</small>
            </div>
