...
session_start();
    ...
    //something was posted
        ...
        {
            //save to database
            $request_id = random_num(11);
              $query = "INSERT INTO request (request_id,full_name,email_id,phone_number,age,blood_group,city) VALUES ('$request_id','$full_name','$email_id','$phone_number','$age',
            '$blood_group','$city')";
...
<body>
    <div class="container">
        <div class="title">Request Plasma</div>
        <div class="content">
