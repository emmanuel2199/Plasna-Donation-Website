...
<body>
 ...
 ?>
                <tr class="text-center">
                    ...
                    <td> <button class="btn-danger btn"> <a href="donordel.php?id=<?php echo $res['id']; ?>"
  ...
  ?>
            ...
            <button class="btn-primary btn"> <a href="donorinsert.php" class="text-white"> Insert </a> </button>
        </div>
    </div>
